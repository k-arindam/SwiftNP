...
public extension MLMultiArray {
    ...
    var toNDArray: NDArray {
        get throws(SNPError) {
            try NDArray.from(self)  // Attempts to create an NDArray from this MLMultiArray.
        }
    }
    ...
    /// - Throws: SNPError if the conversion fails.
    static func from(ndarray: NDArray) throws(SNPError) -> MLMultiArray {
...
public extension NDArray {
    ...
    /// - Throws: SNPError if the conversion fails.
    static func from(_ mlMultiArray: MLMultiArray) throws(SNPError) -> NDArray {
        ...
        return try NDArray(array: array)  // Create and return an NDArray from the unpacked array.
    }
