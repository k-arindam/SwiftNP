...
public extension UIImage {
    ...
    convenience init(ndarray: NDArray) throws(SNPError) {
...
public extension NDArray {
    ...
    static func from(_ image: UIImage) throws(SNPError) -> NDArray {
        ...
        return try NDArray(array: result, contentType: .image)
    }
