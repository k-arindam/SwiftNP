...
internal final class Constants {
    ...
    internal static let packageName: String = "SwiftNP"
    internal static let packageVersion: String = "0.0.8"
    internal static let packageURL: String = "https://github.com/k-arindam/SwiftNP.git"
